...
Het gebruik van milieu-rubrieken (beheertegel *Milieurubrieken* (tbmilrubriek)) is vrijer geworden met deze versie.
...
In dit geval is de dropdown lijst echter bepaald door de rubrieken waarvoor geldt dat het aanvinkvakje *Opslag* gevuld is. Hier kan dus een rubriek koeling mogelijk worden veranderd in rubriek bodem (code 3), waardoor de opslagkaart vanaf dan alleen zichtbaar is achter tegels die de code 3 in de action hebben staan.
