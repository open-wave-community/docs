...
type Handhaving* bij een DSO project. Dit houdt in de handhavingen die
...
-  De tegel is alleen zichtbaar voor inlogger wanneer:
   ...
   -  de evaluatie van het *SQL statement onzichtbaar* bij de
      ...
      -  de tegel is zichtbaar als er handhavingzaken zijn (zowel open
...
-  Dynamisch tegelopschrift:
   *getTileContent(dso_vervolgzaak_handhaving,{id})*
-  Actie:
   *getFlexList(SysStandardList,,{id},nil,dso_vervolgzaak_handhaving)*
