...
type Informatie WKB* bij een DSO project.
...
-  Dynamisch tegelopschrift:
   *getTileContent(dso_informatiewkb_lopend,{id})*
-  Actie:
   *getFlexList(SysStandardList,tbdsoproject,{id},nil,dso_informatiewkb_lopend)*
