...
Het daadwerkelijk plaatsen van de file (op fileshare, of cmis of Stuf zaak/DMS) gaat gelijk aan het beschrevene in het lemma [Upload document(en)](upload_document.md), waarbij het volgende extra geldt:
