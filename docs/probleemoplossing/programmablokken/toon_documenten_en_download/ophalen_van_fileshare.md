...
Afhankelijk van of de instelling _Sectie: documenten, Item: OphalenNaMapkeuze_ is aangevinkt (zie vorige pagina [Toon documenten en download](/docs/probleemoplossing/programmablokken/toon_documenten_en_download.md)) zal de gebruiker eerst uit deze mogelijke mappen een keuze kunnen maken.
