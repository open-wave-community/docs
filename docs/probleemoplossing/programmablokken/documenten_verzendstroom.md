...
Voor het opnemen van een verwijzing naar de bijlages in het gecreëerde document zie kopje _Speciale childquery: Opsommen aangewezen bijlages_ van [Documentsjablonen en Sjabloongroepen](/docs/instellen_inrichten/documentsjablonen.md).
...
Aangetekend en track- en tracecode: zie kopje _Blok Aangetekend_ bij [Detailscherm Geregistreerd Document](/docs/probleemoplossing/module_overstijgende_schermen/geregistreerde_documenten/detailscherm_geregistreerd_document.md).
