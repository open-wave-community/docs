...
[<img src="/_media/openwave/applicatiebeheer/instellen_inrichten/adresrollen.png?w=400&amp;tok=4eabe5" class="media" loading="lazy" alt="" width="400" />](/_detail/openwave/applicatiebeheer/instellen_inrichten/adresrollen.png?id=docs%3Aapplicatiebeheer%3Ainstellen_inrichten%3Aadresrollen)
...
Niet op de database, maar wel in programmacode is afgevangen:
  ...
  - Bij een [inrichting](/docs/applicatiebeheer/instellen_inrichten) kan in de tabel tbmilcontactennn maar één rij voorkomen met de adresrol MHC
