...
![](/docs/img/applicatiebeheer/instellen_inrichten/compartiment.png){ class="media" loading="lazy" alt="" width="400" }
...
### Blok Zaak/DMS
  ...
  - **Wijziging zaakomschrijving of bevoegdgezag doorgeven in updatezaakbericht zaak/dms** (dldmsupdatezaakbericht). Zie [UpdateZaak-bericht wijzigen metadata(StUF)](/probleemoplossing/programmablokken/wijzigen_omschrijvingdata_zaak_dms.md).
