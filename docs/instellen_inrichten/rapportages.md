...
API(s):
  ...
  - getReportGroupList: [https://api.open-wave.nl/RemMethods/getRemMethod/391](https://api.open-wave.nl/RemMethods/getRemMethod/391)
    - getReportGroupDetail: [https://api.open-wave.nl/RemMethods/getRemMethod/392](https://api.open-wave.nl/RemMethods/getRemMethod/392)
    - getReportList: [https://api.open-wave.nl/RemMethods/getRemMethod/393](https://api.open-wave.nl/RemMethods/getRemMethod/393)
    - getReportDetail: [https://api.open-wave.nl/RemMethods/getRemMethod/394](https://api.open-wave.nl/RemMethods/getRemMethod/394)
    - getReportParamsList: [https://api.open-wave.nl/RemMethods/getRemMethod/395](https://api.open-wave.nl/RemMethods/getRemMethod/395)
    - getReportParamsDetail: [https://api.open-wave.nl/RemMethods/getRemMethod/396](https://api.open-wave.nl/RemMethods/getRemMethod/396)
    - getMyReportGroupList: [https://api.open-wave.nl/RemMethods/getRemMethod/401](https://api.open-wave.nl/RemMethods/getRemMethod/401)
    - getMyReportList: [https://api.open-wave.nl/RemMethods/getRemMethod/404](https://api.open-wave.nl/RemMethods/getRemMethod/404)
...
Tegels met rapportgroepen kunnen makkelijk worden ingedeeld in het daartoe bestemde portaal [Rapportageportaal](/docs/applicatiebeheer/probleemoplossing/portalen_en_moduleschermen/rapportageportaal). Maar ze kunnen ook op andere portalen worden geplaatst…
...
### Kolommen
  ...
  - Het aanvinken van de kolom **WMS** (dlwms) betekent dat de rapportage bedoeld is om als WMS_laag gepubliceerd te worden. Zie: [Rapportage als WMS-laag](/docs/applicatiebeheer/instellen_inrichten/rapportage-publiceren_als_wms-laag).
  ...
  - In de kolom **SQL-1** (dvquery) moet een valide SQL statement komen die de rapportage definieert beginnend met 'Select'. Daarbij geldt:
    ...
    - dat Open_Wave functies gebruikt kunnen worden in de SQL zie [OpenWave database functies](/docs/applicatiebeheer/instellen_inrichten/openwave_database-functies)
...
Zie verdere informatie over action: [Actions](/docs/applicatiebeheer/instellen_inrichten/actions).

#### Triggers

In het menu opties rechtsboven. Zie ook [Scherm(kolom)definitie](/docs/applicatiebeheer/instellen_inrichten/schermdefinitie):
...
Zie [Scherminformatie voor lijstschermen en (dus ook) rapportages](/docs/applicatiebeheer/instellen_inrichten/schermdefinitie/scherminformatie_voor_lijstschermen_en_rapportages) voor de juiste volgordeplek van de tags exceltype en excelformat binnen een schermkolomdefinitie.
...
[<img src="/_media/openwave/applicatiebeheer/instellen_inrichting/acthortegel.png?w=300&amp;tok=086a75" class="media" loading="lazy" alt="" width="300" />](/_detail/openwave/applicatiebeheer/instellen_inrichting/acthortegel.png?id=docs%3Aapplicatiebeheer%3Ainstellen_inrichten%3Arapportages)

Klikken op de tegel (mits geautoriseerd) laat de rapportagelijst zien:

[<img src="/_media/openwave/applicatiebeheer/instellen_inrichting/acthorlijst.png?w=500&amp;tok=a0d17c" class="media" loading="lazy" alt="" width="500" />](/_detail/openwave/applicatiebeheer/instellen_inrichting/acthorlijst.png?id=docs%3Aapplicatiebeheer%3Ainstellen_inrichten%3Arapportages)
...
[<img src="/_media/openwave/applicatiebeheer/instellen_inrichting/rapportaction.png?w=600&amp;tok=55aa5d" class="media" loading="lazy" alt="" width="600" />](/_detail/openwave/applicatiebeheer/instellen_inrichting/rapportaction.png?id=docs%3Aapplicatiebeheer%3Ainstellen_inrichten%3Arapportages)

**De rapportparameter**

De parameter %portalid% uit SQL-2 is als volgt gedefinieerd:

[<img src="/_media/openwave/applicatiebeheer/instellen_inrichting/rapportparameter.png?w=600&amp;tok=714481" class="media" loading="lazy" alt="" width="600" />](/_detail/openwave/applicatiebeheer/instellen_inrichting/rapportparameter.png?id=docs%3Aapplicatiebeheer%3Ainstellen_inrichten%3Arapportages)
...
[<img src="/_media/openwave/applicatiebeheer/instellen_inrichting/acthorportaltile.png?w=600&amp;tok=117e6e" class="media" loading="lazy" alt="" width="600" />](/_detail/openwave/applicatiebeheer/instellen_inrichting/acthorportaltile.png?id=docs%3Aapplicatiebeheer%3Ainstellen_inrichten%3Arapportages)
